...
+ (MASManager * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
/// Margin Left value for a content of a cell
@property (nonatomic) CGFloat menuCellMarginLeft;
/// Tells to use real images sizes to define a size of ImageView in cells
@property (nonatomic) BOOL menuCellUseImagesSize;
/// If true, uppercase standard text in cells (to ABOUT, RATE US etc.)
@property (nonatomic) BOOL menuCellFamilyTextUppercase;
/// Height for a cell in Side Menu
...
/// Show ‘Quick links’ and other titles of sections in Side Menu
@property (nonatomic) BOOL menuSectionTitlesShow;
/// Status bar color in hamburger menu view
@property (nonatomic, strong) UIColor * _Nullable statusBarColor;
/// Buy button color in store view controller
@property (nonatomic, strong) UIColor * _Nullable buyButtonColor;
/// Buy button text color in store view controller
@property (nonatomic, strong) UIColor * _Nullable buyButtonTextColor;
...
/// Staus bar custom background color, to be used when status bar should have different color than navigation
@property (nonatomic, strong) UIColor * _Nullable navigationStatusBarColor;
...
@property (nonatomic) BOOL hidePromoBanner;
...
- (enum MASUserState)getUserState SWIFT_WARN_UNUSED_RESULT;
/// TODO
...
/// Subscribe the device with for Firebase clound messaging with already generated FCM token
/// -parameter token: FCM token
- (void)subscribeNotificationsWithToken:(NSString * _Nonnull)token completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
/// Unsubscribe the device with for Firebase clound messaging with already generated FCM token
/// -parameter token: FCM token
- (void)unsubscribeNotificationsWithToken:(NSString * _Nonnull)token completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
@end
